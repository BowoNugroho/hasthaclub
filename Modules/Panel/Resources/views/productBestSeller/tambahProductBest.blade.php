<div class="modal" id="tambahProductBest" tabindex="-1">
        ...
        <form id="producBestForm">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary ms-auto">
                ...
                <span class="spinner-border spinner-border-sm me-2" id="spinnerBest" role="status" style="display: none;"></span>
            </button>
          </div>
        </form>
      </div>
