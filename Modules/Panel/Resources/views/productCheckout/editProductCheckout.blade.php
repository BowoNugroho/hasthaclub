<div class="modal" id="editProductCheckout" tabindex="-1">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form id="editProductCheckoutForm">
          @csrf
          <div class="modal-body">
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-3">
                    <input type="hidden" name="product_checkout_id" id="product_checkout_id">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary ms-auto">
                ...
                <span class="spinner-border spinner-border-sm me-2" id="editspinnerCheckout" role="status" style="display: none;"></span>
            </button>
          </div>
        </form>
      </div>
