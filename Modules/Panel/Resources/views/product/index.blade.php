    ...
    <div class="card card-md">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-10">
            <button  type="button" class="btn btn-primary btn-md m-2 float-end" data-bs-toggle="modal" data-bs-target="#tambahProduct">Tambah</button>
          </div>
        </div>
          <table id="product_datatables" class="display">
              <thead>
                  <tr>
                      <th>Id</th>
                      <th>Name</th>
...
@include('panel::product.tambahProduct')
@include('panel::product.editProduct') 
@endsection

@include('panel::product.js')
