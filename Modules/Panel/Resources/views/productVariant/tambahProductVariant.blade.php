        ...
        <form id="productVariantForm">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="file" class="form-control" id="product_variants_img1" name="product_variants_img1">
            </div>
            <div class="mb-3">
              <label for="image2" class="form-label">Gambar 2</label>
              <input type="file" class="form-control" id="product_variants_img2" name="product_variants_img2">
            </div>
              {{-- <div class="mb-3">
