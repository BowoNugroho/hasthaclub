...
class ColorController extends Controller
{
    ...
    {
        return view('panel::color.index');
    }

    // Fetch data for DataTable with server-side processing
    public function datatables(Request $request)
    {
        $columns = ['id', 'color_name', 'deskripsi', 'created_at'];  // Define the columns you want to display
        $query = Color::query();  // Replace with, your actual model
