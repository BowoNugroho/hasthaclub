...
<div class="grid xl:grid-cols-5 grid-cols-5 p-5">
    <div class="box "></div>
    <div class="box 2xl:col-span-3  xl:col-span-5 col-span-5 ">
        ...
        <div class="grid xl:grid-cols-2 lg:grid-cols-2 grid-cols-1">
            <div class="box ">
                <div class="xl:ml-20 lg:ml-20 md:ml-20 ml-10">
                    ...
                    <div class="mb-5 mt-3">
                        <div class="relative">
                            ...
                            <select id="type_data" name="type_data" onclick="selectData()" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none md:w-3/4 w-11/12 p-3  peer" placeholder=" ">
                    ...
                    <div class="mb-5 mt-3">
                        <div class="relative">
                        <input type="text" id="customer_name" name="customer_name" class="block  p-3 bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none md:w-3/4 w-11/12  peer @error('customer_name') is-invalid @enderror" placeholder="  " value="" >
                    ...
                    <div class="mb-5 mt-3">
                        <div class="relative">
                        <input type="text" id="customer_no_hp" name="customer_no_hp" class="block  p-3 bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none md:w-3/4 w-11/12  peer @error('customer_no_hp') is-invalid @enderror" placeholder="  " value="" >
                    ...
                    <div class="mb-5 mt-3">
                        <div class="relative">
                        <input type="text" id="customer_email" name="customer_email" class="block  p-3 bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none md:w-3/4 w-11/12  peer @error('customer_email') is-invalid @enderror" placeholder="  " value="" >
                    ...
                    <div class="xl:mb-5 lg:mb-5 mt-3">
                        <div class="relative">
                        <textarea name="customer_alamat" id="customer_alamat" name="customer_alamat" cols="30" rows="4" class="block  p-3 bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none md:w-3/4 w-11/12  peer @error('customer_alamat') is-invalid @enderror" placeholder="  "></textarea>
            ...
            <div class="box ">
                <div class="xl:ml-20 lg:ml-20 md:ml-20 ml-10">
                    <p class="text-2xl font-bold text-white text-start mb-5 xl:mt-5 lg:mt-5 ">Data Penerima</p>
                    <div class="mb-5 mt-3">
                        <div class="relative">
                            <textarea name="catatan" id="catatan" name="catatan" cols="30" rows="4" class="block  p-3 bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none md:w-3/4 w-11/12  peer @error('catatan') is-invalid @enderror" placeholder="  "></textarea>
                            <label for="catatan" 
                    ...
                    <div class="mb-5 mt-3">
                            <div class="relative grid">
                                <select id="type_pemesanan" name="type_pemesanan"  onclick="typePemesanan()" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none md:w-3/4 w-11/12 p-3  peer" placeholder=" ">
                                    <option value="">- pilih -</option>
